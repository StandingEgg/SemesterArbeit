...
\end{pmatrix} 
\end{equation}
For assembly of strain and stress, we need to combine the contribution at each node. The procedure is:
...
\epsilon_{5xx}^{\left(1\right)}+\epsilon_{1xx}^{\left(2\right)}&\epsilon_{5yy}^{\left(1\right)}+\epsilon_{1yy}^{\left(2\right)}&\epsilon_{5zz}^{\left(1\right)}+\epsilon_{1zz}^{\left(2\right)}&2\epsilon_{5yz}^{\left(1\right)}+2\epsilon_{1yz}^{\left(2\right)}&2\epsilon_{5xz}^{\left(1\right)}+2\epsilon_{1xz}^{\left(2\right)}&2\epsilon_{5xy}^{\left(1\right)}+2\epsilon_{1xy}^{\left(2\right)}  \\

\epsilon_{6xx}^{\left(1\right)}+\epsilon_{2xx}^{\left(2\right)}&\epsilon_{6yy}^{\left(1\right)}+\epsilon_{2yy}^{\left(2\right)}&\epsilon_{6zz}^{\left(1\right)}+\epsilon_{2zz}^{\left(2\right)}&2\epsilon_{6yz}^{\left(1\right)}+2\epsilon_{2yz}^{\left(2\right)}&2\epsilon_{6xz}^{\left(1\right)}+2\epsilon_{2xz}^{\left(2\right)}&2\epsilon_{6xy}^{\left(1\right)}+2\epsilon_{2xy}^{\left(2\right)} \\

\epsilon_{3xx}^{\left(1\right)}+\epsilon_{3xx}^{\left(2\right)}&\epsilon_{3yy}^{\left(1\right)}+\epsilon_{3yy}^{\left(2\right)}&\epsilon_{3zz}^{\left(1\right)}+\epsilon_{3zz}^{\left(2\right)}&2\epsilon_{3yz}^{\left(1\right)}+2\epsilon_{3yz}^{\left(2\right)}&2\epsilon_{3xz}^{\left(1\right)}+2\epsilon_{3xz}^{\left(2\right)}&2\epsilon_{3xy}^{\left(1\right)}+2\epsilon_{3xy}^{\left(2\right)} \\

\epsilon_{4xx}^{\left(1\right)}+\epsilon_{4xx}^{\left(2\right)}&\epsilon_{4yy}^{\left(1\right)}+\epsilon_{4yy}^{\left(2\right)}&\epsilon_{4zz}^{\left(1\right)}+\epsilon_{4zz}^{\left(2\right)}&2\epsilon_{4yz}^{\left(1\right)}+2\epsilon_{4yz}^{\left(2\right)}&2\epsilon_{4xz}^{\left(1\right)}+2\epsilon_{4xz}^{\left(2\right)}&2\epsilon_{4xy}^{\left(1\right)}+2\epsilon_{4xy}^{\left(2\right)} \\
...
\sigma_{5xx}^{\left(1\right)}+\sigma_{1xx}^{\left(2\right)}&\sigma_{5yy}^{\left(1\right)}+\sigma_{1yy}^{\left(2\right)}&\sigma_{5zz}^{\left(1\right)}+\sigma_{1zz}^{\left(2\right)}&\sigma_{5yz}^{\left(1\right)}+\sigma_{1yz}^{\left(2\right)}&\sigma_{5xz}^{\left(1\right)}+\sigma_{1xz}^{\left(2\right)}&\sigma_{5xy}^{\left(1\right)}+\sigma_{1xy}^{\left(2\right)}  \\

\sigma_{6xx}^{\left(1\right)}+\sigma_{2xx}^{\left(2\right)}&\sigma_{6yy}^{\left(1\right)}+\sigma_{2yy}^{\left(2\right)}&\sigma_{6zz}^{\left(1\right)}+\sigma_{2zz}^{\left(2\right)}&\sigma_{6yz}^{\left(1\right)}+\sigma_{2yz}^{\left(2\right)}&\sigma_{6xz}^{\left(1\right)}+\sigma_{2xz}^{\left(2\right)}&\sigma_{6xy}^{\left(1\right)}+\sigma_{2xy}^{\left(2\right)} \\

\sigma_{3xx}^{\left(1\right)}+\sigma_{3xx}^{\left(2\right)}&\sigma_{3yy}^{\left(1\right)}+\sigma_{3yy}^{\left(2\right)}&\sigma_{3zz}^{\left(1\right)}+\sigma_{3zz}^{\left(2\right)}&\sigma_{3yz}^{\left(1\right)}+\sigma_{3yz}^{\left(2\right)}&\sigma_{3xz}^{\left(1\right)}+\sigma_{3xz}^{\left(2\right)}&\sigma_{3xy}^{\left(1\right)}+\sigma_{3xy}^{\left(2\right)} \\

\sigma_{4xx}^{\left(1\right)}+\sigma_{4xx}^{\left(2\right)}&\sigma_{4yy}^{\left(1\right)}+\sigma_{4yy}^{\left(2\right)}&\sigma_{4zz}^{\left(1\right)}+\sigma_{4zz}^{\left(2\right)}&\sigma_{4yz}^{\left(1\right)}+\sigma_{4yz}^{\left(2\right)}&\sigma_{4xz}^{\left(1\right)}+\sigma_{4xz}^{\left(2\right)}&\sigma_{4xy}^{\left(1\right)}+\sigma_{4xy}^{\left(2\right)} \\
...
\chapter{The Patch Test}
After computing strain and stress in AMfe Toolbox, We need to know if the finite element programm have the algorithmic procedure correctly. This is generally not easy to verify if the modelling is too complex. The patch test is an useful technique to check convergent performance of element type that is being tested. The basic idea of the patch test is to apply special boundary condition to keep a constant strain/stress state. It is to simplify a complex problem to a simple one, which you already know the correct numerical results. 
