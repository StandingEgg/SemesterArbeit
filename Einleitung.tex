...
\begin{equation}
\int {\textbf{\textit{f}}}\left(x\right) \mathrm{d}\Omega = \int {\textbf{\textit{f}}}\left(x\right) \frac{\partial \boldsymbol{\xi}}{\partial \boldsymbol{\xi}} \mathrm{d}\Omega = \int {\textbf{\textit{f}}}\left(x\right) \frac{\partial \Omega}{\partial \xi} \mathrm{d}\xi = \int f\left(x\right) det\left(\frac{\partial X}{\partial \xi}\right) \mathrm{d}\xi
\end{equation}
...
\begin{equation}
\int \limits_E f\left(\xi\right) \mathrm{d\xi_1}\mathrm{d\xi_2}\mathrm{d\xi_3} = \displaystyle\sum_{i=1}^{numgp_1}\displaystyle\sum_{j=1}^{numgp_2} \displaystyle\sum_{k=1}^{numgp_3} f\left(\tilde{\xi_1^i}\tilde{\xi_2^j}\tilde{\xi_3^k}\right)\cdot w_1^i w_2^j w_3^k 
\end{equation}
