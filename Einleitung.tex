...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{Mesh with Tet4. upper: contour plot of $\epsilon_{xx}$ from ANSYS; lower: contour plot of $\epsilon_{xx}$ calculated in AMfe, demonstrate in ParaView} \label{fig: Tet10Exx}
	\end{center}
\end{figure}
\clearpage 
